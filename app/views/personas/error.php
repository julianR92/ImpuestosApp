...
<div class="col-md-12 mt-4">
   ...
   <p class="h4 mb-5">
      Ha ocurrido un error al intentar realizar el registro, por favor intente de nuevo o comuniquese con la entidad.
   </p>
   <p class="h4"><code>Detalle del error: <?= $this->error; ?></code></p>

...
<div class="container pt-2">
   <div class="row">
      ...
      <div class="col-md-12 pt-5 box">
         <h1 class="headline-xl-govco">Actualizar Tipo de Agente</h1>
            ...
            <div class="row pt-5">
               ...
               <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select class="form-control agente" name="tipo_agente" id="tipo_agente" required="required" data-toggle="popover" data-trigger="focus" data-placement="top" data-custom-class="popover-info" title="Valores de Referencia" data-content="PREFERENCIAL: ingresos <= 300UVT,  
...
<script type="text/javascript">
   ...
   frm.onsubmit = (e) => {
      ...
      swal({
         title: "Atención!!",
         text: '¿Estas seguro de actualizar el tipo de agente?',
         type: 'warning',
         ...
         if (isConfirm) {
            ...
            jQuery.ajax({
               url: '<?= PROOT ?>admin/actualizaTipoAgente',
               method: "POST",
               data: formData,

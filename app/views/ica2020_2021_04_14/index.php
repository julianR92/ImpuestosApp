...
<script type="text/javascript">
   ...
   btnConsultar.addEventListener('click', event => {
    ...
    $('#txtNit').change(function() {
            ...
            var input8 = document.getElementById('txtNit').value;
            var ValInput8 = input8.match(/^[0-9]{5,15}$/);
            if (ValInput8 == null) {


               alert("Solo se permiten números, digite su identificación nuevamente sin espacios ni puntos");
               $('#txtNit').focus();
               $('#txtNit').val('');

                     ...
                     <table class="table table-bordered" width="100%" cellpadding="0">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td colspan="2" rowspan="1"><input name="autoBienes_bomberos" id="autoBienes_bomberos" class="entrada form-control suma9" onkeypress="return Numeros(event)" maxlength="20"></td>
                           ...
                           <tr>
                              ...
                              <td colspan="2" rowspan="1"><input name="autoServicios_bomberos" id="autoServicios_bomberos" class="entrada form-control suma9" onkeypress="return Numeros(event)" maxlength="20"></td>
                           ...
                           <tr>
                              ...
                              <td colspan="2" rowspan="1"><input name="otrasAuto_bomberos" id="otrasAuto_bomberos" class="entrada form-control suma9" onkeypress="return Numeros(event)" maxlength="20"></td>
                           ...
                           <tr>
                              ...
                              <td colspan="6" rowspan="1">MENOS RET. POR BIENES QUE LE PRACTICARON EN EL PERIODO</td>
                              ...
                              <td colspan="2" rowspan="1"><input name="menosRetenBie_bomberos" id="menosRetenBie_bomberos" value="0" class="entrada form-control" onkeypress="return Numeros(event)" maxlength="20"></td>
                           ...
                           <tr>
                              ...
                              <td colspan="6" rowspan="1">MENOS RET. POR SERVICIOS QUE LE PRACTICARON EN EL PERIODO</td>
                           ...
                           <tr>
                              ...
                              <td colspan="2" rowspan="1"><input name="menosRetenOtras_bomberos" id="menosRetenOtras_bomberos" value="0" class="entrada form-control" onkeypress="return Numeros(event)" maxlength="20"></td>
      ...
      function guardarDeclaracion() {
         ...
         jQuery.ajax({
            ...
            success: function(resp) {
               if (resp.success) { 
                  alertMsg('Proceso existoso!', 'Su declaración ha sido guardada con exito.', 'success', 4000);

      ...
      <div class="col-md-12 pt-5 box">
         ...
         <form action="" role="form" id="form_nuevoage">
            ...
            <div class="row pt-5 body">
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     <label for="nit_representante" id="nit_representante_label">Identificación de representante legal*</label>
...
<script type="text/javascript">
   ...
   $('#tipo_persona').change(function() {
      ...
      if (input0 == 'N') {
         ...
         $('#nit_representante_label').text('Identificación de representante legal');

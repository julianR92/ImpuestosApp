...
<div class="body">
      ...
      <form action="" method="POST" id="frm">
                     ...
                     <table class="table table-bordered" width="100%" cellpadding="0">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td colspan="6" rowspan="1"><strong>TOTAL RETENCIONES PRACTICADAS (Suma de casillas 1 + 2 + 3)</strong></td>
                           ...
                           <tr>
                              ...
                              <td colspan="6" rowspan="1"><strong>MENOS RETENCION QUE LE PRACTICARON AL PERIODO (Suma de Casillas 8.1 + 8.2 + 8.3)</strong></td>
                              <td colspan="2" rowspan="1"><input name="menosReten_indcio" id="menosReten_indcio" class="entrada form-control totales" onkeypress="return Numeros(event)" value="0" maxlength="20" readonly="readonly"></td>
                              <td colspan="2" rowspan="1"><input name="menosReten_avisos" id="menosReten_avisos" value="0" class="entrada form-control totales" onkeypress="return Numeros(event)" maxlength="20" readonly="readonly"></td>
                              <td colspan="2" rowspan="1"><input name="menosReten_bomberos" id="menosReten_bomberos" value="0" class="entrada form-control totales" onkeypress="return Numeros(event)" maxlength="20" readonly="readonly"></td>
                              <td colspan="2" rowspan="1"><input name="menosReten_total" id="menosReten_total" class="entrada form-control totales" onkeypress="return Numeros(event)" maxlength="20" readonly="readonly" value="0"></td>
                           </tr>
                           ...
                           <tr>
                              ...
                              <td colspan="6" rowspan="1"><strong>TOTAL AUTORRETENCIONES PRACTICADA (Suma de Casillas 5 + 6 + 7 - 8)</strong></td>
                           ...
                           <tr>
                              ...
                              <td colspan="6" rowspan="1"><strong>TOTAL RETENCIONES Y AUTORRETENCIONES PRACTICADAS (Suma de Casillas 4 + 9)</strong></td>
                           ...
                           <tr>
                              ...
                              <td colspan="2" rowspan="1"><input name="total_declaracion" id="total_declaracion" class="entrada form-control totales" onkeypress="return Numeros(event)" maxlength="20" value="0">
                              <input type="hidden" name="total_declaracion_sin_aprox_cambio_milena_1" id="total_declaracion_sin_aprox_cambio_milena_1" class="entrada form-control totales" onkeypress="return Numeros(event)" maxlength="20" value="0">
                              </td>
                           </tr>
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <button type="button" onclick="guardarDeclaracion();" class="btn btn-round btn-middle" style="float: right;">ELABORAR DECLARACION</button>
            </div>
         </div>
      </form>
   </div>
   ...
   <script type="text/javascript">
      ...
      function totalDeclaracion() {
         ...
         $('#total_declaracion_sin_aprox_cambio_milena_1').val(total_declaracion);
         //console.log($('#total_declaracion_sinAprox').val());

...
<script type="text/javascript">
   ...
   function eliminar(vigencia,nit,mes){
            
    
          swal({
         title: "Atención!!",
         text: '¿Estas seguro de eliminar esta declaración?',
         type: 'warning',
      ...
      function(isConfirm) {
         if (isConfirm) {
            ...
            jQuery.ajax({
               url: '<?= PROOT ?>ica/deleteDeclaracion',
               method: "POST",
               data: datos,
               success: function(resp) {
                  ...
                  if(resp.success){
                   ...
                   alertMsg('Operación Exitosa!', '<strong> Declaración eliminada exitosamente </strong>', 'success', 4000);
                   //$('#container_table').css('display', 'none');
                   buscarDeclaraciones();
                   return                  
                 ...
                 alertMsg('Error!', '<strong> Ocurrio Un error a eliminar la declaracion </strong>', 'error', 4000);
                 return;
              }
           }
        });

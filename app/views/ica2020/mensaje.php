               ...
               <div class="card govco-card">
                  ...
                  <form action="<?= PROOT ?>ica/validarNit" method="POST">
                     <div class="card-body text-center">
                        <h5>Apreciado ciudadano, usted ya realizo los 5 intentos de seguridad permitidos en el día, por favor verificar los datos e intentar mañana de nuevo, gracias.</h5><br>
                     </div>
                     <hr>

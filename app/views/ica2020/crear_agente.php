...
<div class="container pt-2">
   <div class="row">
      ...
      <div class="col-md-12 pt-5 box">
         ...
         <form action="" role="form" id="form_nuevoage">
            ...
            <div class="row pt-5 body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           REGIMEN COMUN: ingresos entre > 300UVT y <= 80000UVT, GRAN CONTRIBUYENTE: ingresos > 80000UVT">
                              ...
                              <option <?php if ($this->calidadAgente == 'C') echo 'selected'; ?> value="C">Régimen Común <small>(ingresos entre > 300UVT y <= 80000UVT)</small>
                              </option>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control periodicidad" name="cb_periodo" id="cb_periodo" required="required" data-toggle="popover" data-trigger="focus" data-placement="top" data-custom-class="popover-info" title="Valores de Referencia" data-content="TRIMESTRAL: ingresos < 5000UVT,  
                           MENSUAL: ingresos entre >= 5000UVT">
                              <option value="">Seleccionar*</option>
                              <option <?php if ($this->presentacion == 'Mensual') echo 'selected'; ?> value="Mensual">MENSUAL <small>(ingresos entre >= 5000UVT)</small></option>
                              <option <?php if ($this->presentacion == 'Trimestral') echo 'selected'; ?> value="Trimestral">TRIMESTRAL<small>(ingresos < 5000UVT)</small>
                              </option>
                           </select>
               ...
               <div class="col-md-8 box_juridica">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="razon_social" id="razon_social" onkeypress="return Razon(event)" maxlength="80" onchange="aMayusculas(this.value,this.id)">
                  </div>
               </div>
               ...
               <div class="col-md-4 box_natural" style="display: none">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="primer_nombre" id="primer_nombre" onkeypress="return Letras(event)" maxlength="15" onchange="aMayusculas(this.value,this.id)">
                  </div>
               </div>
               ...
               <div class="col-md-4 box_natural" style="display: none">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="segundo_nombre" id="segundo_nombre" onkeypress="return Letras(event)" maxlength="15" onchange="aMayusculas(this.value,this.id)">
                  </div>
               </div>
               <div class="col-md-4 box_natural" style="display: none">
                  <div class="form-group">
                     <label for="primer_apellido">Primer Apellido*</label>
                     <input type="text" class="form-control" name="primer_apellido" id="primer_apellido" onkeypress="return Letras(event)" maxlength="15" onchange="aMayusculas(this.value,this.id)">
                  </div>
               </div>
               <div class="col-md-4 box_natural" style="display: none">
                  <div class="form-group">
                     <label for="segundo_apellido">Segundo Apellido</label>
                     <input type="text" class="form-control" name="segundo_apellido" id="segundo_apellido" onkeypress="return Letras(event)" maxlength="60" onchange="aMayusculas(this.value,this.id)">
                  </div>
               </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select class="form-control" name="tipo_contribuyente" id="tipo_contribuyente" required>
                        ...
                        <option value="2">Sist. Tarj. Crédito - Débito</option>
                        <option value="3">Entidad Publica</option>
                        <option value="4">Ent. Transportadores</option>
                        <option value="5">Unión Temporal</option>
                        <option value="6">Consorcio</option>
                        <option value="7">Intermediarios</option>
                        <option value="8">Autoretenedor</option>
                        <option value="9">Designados</option>
                        <option value="10">Régimen común</option>
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     <label for="nit_representante" id="nit_representante_label">NIT Representante Legal*</label>
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     <label for="tipo_documento_representante" id="tipo_documento_representante_label">Tipo de documento*</label>
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" name="nombre2_representante" id="nombre2_representante" class="form-control" onkeypress="return Letras(event)" maxlength="60" onchange="aMayusculas(this.value,this.id)">
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" name="apellido_representante" id="apellido_representante" class="form-control" onkeypress="return Letras(event)" maxlength="60" required onchange="aMayusculas(this.value,this.id)">
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" name="apellido2_representante" id="apellido2_representante" class="form-control" onkeypress="return Letras(event)" maxlength="60" onchange="aMayusculas(this.value,this.id)">
                  </div>
               </div>
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     <label for="telefono_representante" id="telefono_representante_label">Teléfono Representante Legal*</label>
...
<script type="text/javascript">
   ...
   const frm = document.getElementById('form_nuevoage');
   frm.onsubmit = (e) => {
      e.preventDefault();
   ...
   $('.body').ready(function() {
      if ('<?= $this->existeICA ?>' == 'SI') {
         if ('<?= $this->calidadAgente ?>' == 'P' && ('<?= $this->tipo_persona ?>' =='C' || '<?= $this->tipo_persona ?>' =='NO'|| '<?= $this->tipo_persona ?>' =='') ) {
            var mensaje = '<strong>No es posible realizar el registro como agente retenedor, ya que sus ingresos declarados en el 2019 son menores a 300UVT, si está en desacuerdo por favor comunicarse a Secretaria de Hacienda a los números 6337000 EXT 251</strong>';
            alertMsg('ATENCIÓN CONTRIBUYENTE!', mensaje, 'warning', 20000);
            setTimeout(function() {
               window.location.href = '<?= PROOT ?>ica';
            }, 18000);
         }
